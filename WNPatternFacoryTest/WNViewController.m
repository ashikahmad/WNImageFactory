...
- (void)viewDidLoad
{
    ...
    [self.view setBackgroundColor:[UIColor colorWithPatternImage:[WNPatternFactory gradientWithSize:self.view.frame.size colorsInfo:@"#adadad, 0%, #d6d6d6, 100%" vertical:NO]]];
    ...
    for (int i=0; i<patterns.count; i++) {
        ...
        [btn setBackgroundImage:[WNPatternFactory gradientWithSize:s colorsInfo:patterns[i] vertical:NO] forState:UIControlStateNormal];
